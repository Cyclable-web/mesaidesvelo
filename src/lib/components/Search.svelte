...
<div
	class="w-full max-w-screen-md m-auto bg-gradient-to-r from-red-100 to-red-200 py-8 px-4 sm:px-6 mt-6 flex flex-col gap-x-4 gap-y-2 sm:flex-row sm:items-center rounded"
>
